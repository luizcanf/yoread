...
CREATE TABLE `avalia` (
  ...
  `cod_publicacao` int(11) NOT NULL,
  `email` varchar(50) NOT NULL,
  PRIMARY KEY (`cod_publicacao`, `email`),
  CONSTRAINT `cod_publicacao_fk2` FOREIGN KEY (`cod_publicacao`) REFERENCES `publicacao` (`cod_publicacao`),
  KEY `email_fk2` (`email`),
  CONSTRAINT `email_fk2` FOREIGN KEY (`email`) REFERENCES `users` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `comenta` (
  ...
  KEY `email_fk3` (`email`),
  CONSTRAINT `email_fk3` FOREIGN KEY (`email`) REFERENCES `users` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
